					 ...
					 GParamSpec *pspec)
{
	...
	case PROP_REVISION_GUARDS:
		e_source_revision_guards_set_guards_enabled (extension, g_value_get_boolean (value));
		return;
	}
				     ...
				     GParamSpec *pspec)
{
	...
	switch (property_id) {
	case PROP_REVISION_GUARDS:
		g_value_set_boolean (value, e_source_revision_guards_get_guards_enabled (extension));
		return;
	}
...
/**
 * e_source_revision_guards_set_guards_enabled:
 ...
 */
void
e_source_revision_guards_set_guards_enabled (ESourceRevisionGuards  *extension,
					     gboolean                enabled)
{
...
/**
 * e_source_revision_guards_get_guards_enabled:
 * @extension: An #ESourceRevisionGuards
 *
 ...
 */
gboolean
e_source_revision_guards_get_guards_enabled (ESourceRevisionGuards *extension)
{
	gboolean enabled;
