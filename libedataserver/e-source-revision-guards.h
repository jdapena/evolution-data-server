...
void            e_source_revision_guards_set_guards_enabled  (ESourceRevisionGuards  *extension,
							      gboolean                enabled);
gboolean        e_source_revision_guards_get_guards_enabled  (ESourceRevisionGuards  *extension);
